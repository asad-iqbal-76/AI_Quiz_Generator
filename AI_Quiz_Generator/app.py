...
try:
    logger.info("Initializing lightweight question generation pipeline...")
    qg_pipeline = pipeline(
        "text2text-generation",
        model="t5-small",  # Smaller model than valhalla/t5-base-e2e-qg
        device=-1
    )

    logger.info("Initializing lightweight question answering pipeline...")
...
try:
    ...
    sentence_model = SentenceTransformer('paraphrase-MiniLM-L6-v2')  # Efficient model
except Exception as e:
